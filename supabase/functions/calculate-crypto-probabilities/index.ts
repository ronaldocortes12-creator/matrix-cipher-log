 ...
 * ═══════════════════════════════════════════════════════════════════
 * 
 * 📊 COMPONENTE 1: MARKET CAP (55% - GLOBAL)
 * ═══════════════════════════════════════════════════════════════════
 * P_mcap = 0.35 × p10 + 0.20 × p40
 * 
 * INVERSÃO CRÍTICA: ⚠️
 * - Saída de dinheiro (z < 0) → ALTA probabilidade de subida
 * - Entrada forte (z > 0) → BAIXA probabilidade de subida
 * 
 * Fórmula: p10 = sigmoid(SLOPE_10 × z10)    [SEM dupla negação]
 *          p40 = sigmoid(SLOPE_40 × z40)
 * 
 * Slopes: SLOPE_10 = 1.8, SLOPE_40 = 1.4
 * 
 * Reforços por magnitude absoluta (ΔUSD):
 * - 10 dias: threshold 100B USD, γ=0.8, norm=200B
 * - 40 dias: threshold 200B USD, γ=0.6, norm=400B
 * 
 * ═══════════════════════════════════════════════════════════════════
 * 
 * ₿ COMPONENTE 2: BITCOIN (25% - GLOBAL)
 * ═══════════════════════════════════════════════════════════════════
 * P_btc = sigmoid(SLOPE_BTC × z_btc_10d)
 * 
 * SLOPE_BTC = 1.6
 * Clamp: [0.10, 0.90]
 * 
 * ═══════════════════════════════════════════════════════════════════
 * 
 * 💰 COMPONENTE 3: PREÇO INDIVIDUAL (20% - POR CRIPTO)
 * ═══════════════════════════════════════════════════════════════════
 * P_price = sigmoid(SLOPE_PRICE × z_price)
 * 
 * SLOPE_PRICE = 1.2
 * z_price calculado com preço AO VIVO do CoinGecko
 * Clamp: [0.05, 0.95]
 * 
 * ═══════════════════════════════════════════════════════════════════
 */
